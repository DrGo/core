...
func Test_getUsableFilePath(t *testing.T) {
	...
	tests := []struct {
		...
		{"abspath", args{"/Users/salah/Dropbox/code/go/src/drgo/core/files/files_test.go", ""}, "/Users/salah/Dropbox/code/go/src/drgo/core/files/files_test.go"},
		{"baseabspath", args{"/Users/salah/Dropbox/code/go/src/drgo/core/files/files_test.go", "/test"}, "/Users/salah/Dropbox/code/go/src/drgo/core/files/files_test.go"},
